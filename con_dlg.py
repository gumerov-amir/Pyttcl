    ...
    def __init__(self, pyttcl):
        ...
        wx.StaticText(
            self, -1, _('Servers list'), pos=(0, 0), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 30
            )
        )
        self.servers_listbox = wx.ListBox(
            self, -1, choices=self.get_servers_list(), pos=(0, 50), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 200
            )
        )
        ...
        wx.StaticText(
            self, -1, _('Server information'), pos=(
                int(self.pyttcl.gui.display_width * 0.384), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 30
            )
        )
        self.server_info_panel = wx.Panel(
            self, -1, pos=(
                int(self.pyttcl.gui.display_width * 0.0769), 70
            ), size=(
                int(self.pyttcl.gui.display_width * 0.6152), 100
            )
        )
        wx.StaticText(
        ...
        self.hostname_textctrl = wx.TextCtrl(
            self.server_info_panel, -1, pos=(0, 50), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 50
            )
        )
        wx.StaticText(
            self.server_info_panel, -1, _('TCP port'), pos=(
                int(self.pyttcl.gui.display_width * 0.0769), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 30
            )
        )
        ...
        wx.StaticText(
            self.server_info_panel, -1, _('UDP port'), pos=(
                int(self.pyttcl.gui.display_width * 0.154), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 30
            )
        )
        self.udpport_textctrl = wx.TextCtrl(
            self.server_info_panel, -1, '10333', pos=(
                int(self.pyttcl.gui.display_width * 0.154), 50
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 50
            )
        )
        wx.StaticText(
            self.server_info_panel, -1, _('User name'), pos=(
                int(self.pyttcl.gui.display_width * 0.231), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 30
            )
        )
        self.username_textctrl = wx.TextCtrl(
            self.server_info_panel, -1, pos=(
                int(self.pyttcl.gui.display_width * 0.231), 50
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 50
            )
        )
        wx.StaticText(
            self.server_info_panel, -1, _('Password'), pos=(
                int(self.pyttcl.gui.display_width * 0.307), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 30
            )
        )
        self.password_textctrl = wx.TextCtrl(
            self.server_info_panel, -1, pos=(
                int(self.pyttcl.gui.display_width * 0.307), 50
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 50
        ...
        self.channel_textctrl = wx.TextCtrl(
            self.server_info_panel, -1, pos=(
                int(self.pyttcl.gui.display_width * 0.384), 50
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 50
            )
        )
        wx.StaticText(
            self.server_info_panel, -1, _('Channel password'), pos=(
                int(self.pyttcl.gui.display_width * 0.462), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 30
            )
        )
        self.channel_password_textctrl = wx.TextCtrl(
            self.server_info_panel, -1, pos=(
                int(self.pyttcl.gui.display_width * 0.462), 50
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 50
            ), style=wx.TE_PASSWORD
        )
        wx.StaticText(
            self.server_info_panel, -1, _('Note name'), pos=(
                int(self.pyttcl.gui.display_width * 0.538), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 30
            )
        )
        self.note_name_textctrl = wx.TextCtrl(
            self.server_info_panel, -1, pos=(
                int(self.pyttcl.gui.display_width * 0.538), 50
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 50
            )
        )
        ...
        remove_button = wx.Button(
            self, -1, _('Remove'), pos=(
                int(self.pyttcl.gui.display_width * 0.692), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.83), 50
            )
        )
        remove_button.Bind(wx.EVT_BUTTON, self.remove_server)
        save_button = wx.Button(
            self, -1, _('Save'), pos=(
                int(self.pyttcl.gui.display_width * 0.769), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 50
            )
        )
        ...
        new_server_button = wx.Button(
            self, -1, _('New server'), pos=(
                int(self.pyttcl.gui.display_width * 0.846), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 50
            )
        )
        ...
        connect_button = wx.Button(
            self, -1, _('Connect'), pos=(
                int(self.pyttcl.gui.display_width * 0.923), 0
            ), size=(
                int(self.pyttcl.gui.display_width * 0.0769), 30
            )
        )
